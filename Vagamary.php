...
try {
    $query = "SELECT name, price FROM foods WHERE restaurants_id = (SELECT id FROM restaurants WHERE name = 'Vagamary Cukrászda')";
...
<head>
    ...
    <title>Vagamary Cukrászda</title>
...
<body>
    ...
    <main>
        <div class="main-content">
            <h2>Vagamary Cukrászda ételei</h2>
            <div class="food-list">
